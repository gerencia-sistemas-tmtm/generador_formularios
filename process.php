...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo "Formulario generado y guardado en <a href='https://tumarkettumodelo.com.mx/Formularios/$directory'  target=_blank> https://tumarkettumodelo.com.mx/Reporter_php/$directory.";
}
?>
